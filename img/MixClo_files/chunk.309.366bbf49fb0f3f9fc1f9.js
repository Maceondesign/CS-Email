/*! For license information please see chunk.309.366bbf49fb0f3f9fc1f9.js.LICENSE.txt */
(self.webpackChunk_ember_auto_import_=self.webpackChunk_ember_auto_import_||[]).push([[309],{66763:function(e,t,r){"use strict"
r.r(t),r.d(t,{KNOWN_CAMPAIGN_AND_AFFILIATE_QUERY_PARAMS:function(){return n},KNOWN_MARKETING_QUERY_PARAMS:function(){return a},METRICS_REGISTER_ENDPOINT:function(){return o},PROCESS_REDIRECT_URL_ENDPOINT:function(){return i},default:function(){return d},handleCampaignAndAffiliateUrls:function(){return l}})
var n=["affC","adId","advp","at","ct","itsct","itscg","itscc","itcCt","its_qt","ls","partnerId","pt","qtkid","uo"],a=["mttn3pid","mttnagencyid","mttncc","mttnmyad","mttnmyadg","mttnmycmp","mttnmykw","mttnmypla","mttnmypub","mttnmysite","mttnpid","mttnrefid","mttnsiteid","mttnsub1","mttnsub2","mttnsub3","mttnsubad","mttnsubadgp","mttnsubcmp","mttnsubkw","mttnsubpid","mttnsubplmnt","mttnsubsite","gclid"],i="https://itunes.apple.com/WebObjects/MZStoreServices.woa/wa/processRedirectUrl",o="https://xp.apple.com/register"
function s(e,t){if(t&&"object"==typeof t)for(var r in t)t[r]&&e.setRequestHeader(r,t[r])}function u(e,t){return new Promise((function(r,n){e.onload=function(){e.status<200||e.status>=300?n({request:e}):r(e)},e.onerror=function(){n({request:e})},t?e.send(t):e.send()}))}function l(e,t){var r=t||{}
...
var a,l=r.endpoint||i
return(a=new XMLHttpRequest,a.open("GET",o),a.withCredentials=!0,u(a)).then((function(){return function(e,t,r){var n;(n=r.customXhr?r.customXhr:"undefined"!=typeof itms?itms.makeStoreXMLHttpRequest():new XMLHttpRequest).open("POST",t),n.withCredentials=!0,s(n,{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}),s(n,r.headers)
var a="url="+encodeURIComponent(e)
return r.ignoreMarketing&&(a+="&ignoreMarketing=true"),u(n,a).then((function(e){var t=e.response
if(200===e.status&&""!==t){var r=JSON.parse(t)
return r.setCookies.forEach((function(e){document.cookie=function(e){return Object.keys(e).reduce((function(t,r){return["name","value"].includes(r)?t:"".concat(t,";").concat(r,"=").concat(e[r])}),"".concat(e.name,"=").concat(e.value))}(e)})),r.redirectUrl}}))}(e,l,r)}))}var d=l},51051:function(e,t){"use strict"
...
r.r(t),r.d(t,{getCLS:function(){return p},getFCP:function(){return v},getFID:function(){return O},getLCP:function(){return S},getTTFB:function(){return M}})
var n,a,i,o,s=function(e,t){return{name:e,value:void 0===t?-1:t,delta:0,entries:[],id:"v1-".concat(Date.now(),"-").concat(Math.floor(8999999999999*Math.random())+1e12)}},u=function(e,t){try{if(PerformanceObserver.supportedEntryTypes.includes(e)){if("first-input"===e&&!("PerformanceEventTiming"in self))return
...
addEventListener("visibilitychange",r,!0),addEventListener("pagehide",r,!0)},d=function(e){addEventListener("pageshow",(function(t){t.persisted&&e(t)}),!0)},f="function"==typeof WeakSet?new WeakSet:new Set,c=function(e,t,r){var n
return function(){t.value>=0&&(r||f.has(t)||"hidden"===document.visibilityState)&&(t.delta=t.value-(n||0),(t.delta||void 0===n)&&(n=t.value,e(t)))}},p=function(e,t){var r,n=s("CLS",0),a=function(e){e.hadRecentInput||(n.value+=e.value,n.entries.push(e),r())},i=u("layout-shift",a)
i&&(r=c(e,n,t),l((function(){i.takeRecords().map(a),r()})),d((function(){n=s("CLS",0),r=c(e,n,t)})))},m=-1,y=function(){return"hidden"===document.visibilityState?0:1/0},h=function(){l((function(e){var t=e.timeStamp
m=t}),!0)},g=function(){return m<0&&(m=y(),h(),d((function(){setTimeout((function(){m=y(),h()}),0)}))),{get timeStamp(){return m}}},v=function(e,t){var r,n=g(),a=s("FCP"),i=function(e){"first-contentful-paint"===e.name&&(l&&l.disconnect(),e.startTime<n.timeStamp&&(a.value=e.startTime,a.entries.push(e),f.add(a),r()))},o=performance.getEntriesByName("first-contentful-paint")[0],l=o?null:u("paint",i);(o||l)&&(r=c(e,a,t),o&&i(o),d((function(n){a=s("FCP"),r=c(e,a,t),requestAnimationFrame((function(){requestAnimationFrame((function(){a.value=performance.now()-n.timeStamp,f.add(a),r()}))}))})))},b={passive:!0,capture:!0},w=new Date,q=function(e,t){n||(n=t,a=e,i=new Date,E(removeEventListener),T())},T=function(){if(a>=0&&a<i-w){var e={entryType:"first-input",name:n.type,target:n.target,cancelable:n.cancelable,startTime:n.timeStamp,processingStart:n.timeStamp+a}
o.forEach((function(t){t(e)})),o=[]}},k=function(e){if(e.cancelable){var t=(e.timeStamp>1e12?new Date:performance.now())-e.timeStamp
"pointerdown"==e.type?function(e,t){var r=function(){q(e,t),a()},n=function(){a()},a=function(){removeEventListener("pointerup",r,b),removeEventListener("pointercancel",n,b)}
addEventListener("pointerup",r,b),addEventListener("pointercancel",n,b)}(t,e):q(t,e)}},E=function(e){["mousedown","keydown","touchstart","pointerdown"].forEach((function(t){return e(t,k,b)}))},O=function(e,t){var r,i=g(),p=s("FID"),m=function(e){e.startTime<i.timeStamp&&(p.value=e.processingStart-e.startTime,p.entries.push(e),f.add(p),r())},y=u("first-input",m)
r=c(e,p,t),y&&l((function(){y.takeRecords().map(m),y.disconnect()}),!0),y&&d((function(){var i
p=s("FID"),r=c(e,p,t),o=[],a=-1,n=null,E(addEventListener),i=m,o.push(i),T()}))},S=function(e,t){var r,n=g(),a=s("LCP"),i=function(e){var t=e.startTime
t<n.timeStamp&&(a.value=t,a.entries.push(e)),r()},o=u("largest-contentful-paint",i)
if(o){r=c(e,a,t)
var p=function(){f.has(a)||(o.takeRecords().map(i),o.disconnect(),f.add(a),r())};["keydown","click"].forEach((function(e){addEventListener(e,p,{once:!0,capture:!0})})),l(p,!0),d((function(n){a=s("LCP"),r=c(e,a,t),requestAnimationFrame((function(){requestAnimationFrame((function(){a.value=performance.now()-n.timeStamp,f.add(a),r()}))}))}))}},M=function(e){var t,r=s("TTFB")
...
r.entries=[t],e(r)}catch(e){}},"complete"===document.readyState?setTimeout(t,0):addEventListener("pageshow",t)}},52215:function(e){"use strict"
